...
class PeintureController extends AbstractController
{
     ...
     */
    public function realisations(PeintureRepository $peintureRepository, PaginatorInterface $paginator, Request $request):
    Response
    {
     ...
     */
    public function realisation(Peinture           $peinture, Request $request, CommentaireRepository $commentaireRepository,
